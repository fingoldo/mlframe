...
def find_maximum_profit_system(
    prices: np.ndarray, tc: float = 0.00001, tc_mode: str = "fraction", optimize_consecutive_regions: bool = True, dtype: object = np.float32
):
    """
...
def show_mps_regions(prices: np.ndarray, positions: np.ndarray = None, tc: float = 0.00001, tc_mode: str = "fraction", figsize=(10, 5)):
