...
- After ANY RUF100/unused-noqa related fix, immediately verify with the project's actual blocking CI gate command (`ruff check . --select F,E9` in this repo) before considering the change done — a narrow-select "clean" result proves nothing about the real gate.
