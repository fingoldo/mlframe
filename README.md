...
[![codecov-full](https://img.shields.io/codecov/c/github/fingoldo/mlframe?flag=combined&label=codecov-full)](https://codecov.io/gh/fingoldo/mlframe/flags)
...
Every environment variable read anywhere in `src/mlframe/`, mechanically generated from the source: see [docs/ENVIRONMENT_VARIABLES.md](docs/ENVIRONMENT_VARIABLES.md).
