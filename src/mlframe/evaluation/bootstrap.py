...
# Wave 100 (2026-07-11): the percentile/BCa CI reducer + all four jackknife estimators (~240 lines,
# including their algorithmic-derivation docstrings) moved to sibling file _bootstrap_jackknife.py to
