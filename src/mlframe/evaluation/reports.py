...
def evaluate_estimators(
    ...
    pre_pipeline: Optional[list] = None,
    val_size: float = 0.5,
    shuffle: bool = True,
    ...
    confusion_matrix_file: Optional[str] = None,
    ...
    threshold: float = 0.5,
    pos_label: int = 1,
    classification_thresholds: Optional[list] = None,
    show_calibration_plot: bool = True,
    use_sklearn_calibration: bool = False,
    calibration_nbins: int = 100,
    dpi=100,
    results_log: Optional[dict] = None,
    target_wrapper: Optional[Callable] = None,
    caption: Optional[str] = None,
    figsize: tuple = (15, 5),
    competing_probs: Optional[list] = None,
    stratify=None,
    plot: bool = True,
...
def plot_beautified_lift(
    ...
    _score: Callable[[np.ndarray, np.ndarray], float]
    if metric == "auroc":
        _score = fast_roc_auc
    elif metric == "auprc":
        _score = average_precision_score
    elif metric == "brier":
        _score = fast_brier_score_loss
