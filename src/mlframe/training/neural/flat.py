...
def generate_mlp(
    ...
    if not isinstance(nlayers, int) or isinstance(nlayers, bool):
        raise ValueError(f"nlayers must be an int, got {type(nlayers).__name__}")
    if nlayers < 1:
    ...
    if not isinstance(min_layer_neurons, int) or isinstance(min_layer_neurons, bool):
        raise ValueError(f"min_layer_neurons must be an int, got {type(min_layer_neurons).__name__}")
    ...
    if num_classes is not None:
        if not isinstance(num_classes, int) or isinstance(num_classes, bool):
            raise ValueError(f"num_classes must be None or an int, got {type(num_classes).__name__}")
        if num_classes < 0:
    ...
    if not isinstance(first_layer_num_neurons, int) or isinstance(first_layer_num_neurons, bool):
        raise ValueError(f"first_layer_num_neurons must be an int, got {type(first_layer_num_neurons).__name__}")
