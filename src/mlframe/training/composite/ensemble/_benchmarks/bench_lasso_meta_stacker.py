"""cProfile harness for ``training.composite.ensemble._stackers.fit_lasso_meta_stacker``.

Run: ``python -m mlframe.training.composite.ensemble._benchmarks.bench_lasso_meta_stacker``
"""
...
from mlframe.training.composite.ensemble._stackers import fit_lasso_meta_stacker
...
def _run(n_rows: int, n_components: int) -> None:
    ...
    fit_lasso_meta_stacker(X, y, n_components)
