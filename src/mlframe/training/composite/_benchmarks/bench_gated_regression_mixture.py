...
def _run(n: int) -> None:
    ...
    mixture = GatedRegressionMixture(gate_classifier=LogisticRegression(max_iter=500), low_regressor=LinearRegression(), high_regressor=LinearRegression(), n_splits=5)
