...
_LAZY_IMPORTS = {
    ...
    "audit_target_over_time": (".targets.target_temporal_audit", "audit_target_over_time"),
    "audit_targets_over_time": (".targets.target_temporal_audit", "audit_targets_over_time"),
    "audit_residuals": (".targets.regression_residual_audit", "audit_residuals"),
    "format_residual_audit_report": (".targets.regression_residual_audit", "format_residual_audit_report"),
    "plot_residual_diagnostics": (".targets.regression_residual_audit", "plot_residual_diagnostics"),
    "ResidualAudit": (".targets.regression_residual_audit", "ResidualAudit"),
    "plot_target_over_time": (".targets.target_temporal_audit", "plot_target_over_time"),
    "format_temporal_audit_report": (".targets.target_temporal_audit", "format_temporal_audit_report"),
    "find_change_points": (".targets.target_temporal_audit", "find_change_points"),
    "find_change_points_pelt": (".targets.target_temporal_audit", "find_change_points_pelt"),
    "find_change_points_zscore": (".targets.target_temporal_audit", "find_change_points_zscore"),
    "TemporalAuditResult": (".targets.target_temporal_audit", "TemporalAuditResult"),
    # Model utilities
...
from ._dataset_cache_fingerprint import compute_signature  # noqa: E402
