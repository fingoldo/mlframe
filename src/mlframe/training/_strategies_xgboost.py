...
Wave 104 (2026-05-21): split out from ``training/strategies.py`` to keep
that file below the 1k-line monolith threshold. Behaviour preserved
bit-for-bit; the class is re-exported from ``strategies`` so existing
...
# Wave 104: parent module re-exports us at the bottom AFTER TreeModelStrategy
# is defined; partial-module import resolves correctly.
from .strategies import TreeModelStrategy, get_polars_cat_columns, is_polars_categorical
