...
from mlframe.training.cb.shared import CB_POOL_CACHE as _CB_POOL_CACHE  # noqa: F401
...
def _configure_mlp_params(
    ...
    if use_regression:
        ...
        from mlframe.training.targets.shared import TTRWithEvalSetScaling as _TTRWithEvalSetScaling
...
from ._trainer_configure_recurrent import _configure_recurrent_params  # noqa: F401 -- re-exported
