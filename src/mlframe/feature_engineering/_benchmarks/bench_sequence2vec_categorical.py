...
from mlframe.feature_engineering.sequence2vec_categorical import train_sequence2vec
...
if __name__ == "__main__":
    for n_entities, seq_len, vocab_size, n_epochs in [(200, 10, 50, 3), (2_000, 20, 200, 1)]:
        ...
        print(f"n_entities={n_entities:>6,} seq_len={seq_len:>3} vocab={vocab_size:>4} n_epochs={n_epochs} -> {wall * 1000:9.2f} ms")
