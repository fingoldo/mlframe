...
| P-3 | P2 | redundant target re-discretization across ~15 FE blocks | _fit_impl_core.py:476-5343 | FIX (shared _y_discrete) | WAVE2b -- monolith y_discrete threading (agent dispatched). |
