...
def _load_old_module() -> types.ModuleType:
    ...
    exec(compile(src, "<HEAD:_conditional_permutation.py>", "exec"), mod.__dict__)  # nosec B102 - src is this repo's own git-history source (git show HEAD:...), not external input
    return mod
