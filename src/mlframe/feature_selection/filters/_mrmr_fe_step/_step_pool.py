...
def build_fe_operand_pool(
    ...
    *,
    ...
    # GATE-OPERAND RE-CLASSIFICATION. A selected conditional_gate / row_argmax feature is
    ...
    # SURROGATE-GBM SPLIT-CO-OCCURRENCE SEEDER + its mandatory
    ...
    # GRADIENT-INTERACTION (MIXED SECOND PARTIALS) SEEDER. Fits one
