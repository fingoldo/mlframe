                ...
                if (
                    ...
                    try:
                        ...
                        if (
                            ...
                            _corr_pair, _corr_single = _usability_form_corrs(_ya, _o0, _o1)
                            ...
                            if _corr_pair >= _min_corr and _corr_pair >= _margin * _corr_single:
                                _admit_via_usability = True
                                if verbose >= 2:
                                    logger.info(
                                        "Factors pair %s ADMITTED via usability (best-form |corr(y)|=%.4f vs "
                                        "best-single %.4f, margin %.2f) despite rank-MI rejection -- "
                                        "tail-concentrated linear signal.",
                                        raw_vars_pair, _corr_pair, _corr_single, _margin,
                                    )
                    except Exception:
                        _admit_via_usability = False
