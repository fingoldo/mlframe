...
from ._entry import (
    ...
    fe_gpu_device_born_extra_basis_enabled,
    fe_gpu_device_born_gate_enabled,
    fe_gpu_device_born_modular_enabled,
    fe_gpu_device_born_uplift_univariate_enabled,
    fe_gpu_device_born_wavelet_enabled,
    fe_gpu_resident_raw_baseline_enabled,
