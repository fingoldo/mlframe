"""Quiet the intermittent cupy<->numba CUDA teardown race at interpreter shutdown.
...
# install_cuda_teardown_guard's idempotency check used to be a
...
def install_cuda_teardown_guard() -> None:
    ...
    Thread-safe: the whole check-then-install sequence runs under a lock."""
