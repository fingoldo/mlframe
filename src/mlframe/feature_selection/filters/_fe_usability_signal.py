...
def _abs_pearson_njit(y, v):
    ...
    MEAN-CENTERED, not raw-sum: a ONE-PASS raw-sum formula (``sum(x^2) - sum(x)^2/n``) computes
    ...
    # Practically-constant floor, not just exactly-zero: a column whose coefficient of variation
