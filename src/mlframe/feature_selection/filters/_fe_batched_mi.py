...
# The device-code range guard lives in a sibling (file-size carve only); re-exported because the parent is
# its only caller and the kernels below reference it by this name.
