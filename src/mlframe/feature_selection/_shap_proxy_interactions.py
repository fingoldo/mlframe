...
def _su_marginals(ids: np.ndarray):
    ...
    from mlframe.feature_selection._shap_proxy_cluster_su import _column_marginal
...
def sparse_interaction_candidates(
    ...
    *,
    ...
    from mlframe.feature_selection._shap_proxy_explain import compute_shap_matrix
