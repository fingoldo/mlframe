...
_DESCRIPTIONS: Dict[str, Dict[str, str]] = {
    ...
    "regression": {
        "PRED_SAMPLE": "Rows at evenly spaced quantiles of the true value as true/predicted line-and-marker pairs, traceable by eye; log or asinh y on a wide-dynamic-range sample.",
