...
# Target-drift wiring carved to _diagnostics_dispatch_drift.py (1k-LOC ceiling); re-exported for existing importers.
from ._diagnostics_dispatch_drift import (  # noqa: F401
    _ADVERSARIAL_CACHE,
    _PSI_CACHE,
