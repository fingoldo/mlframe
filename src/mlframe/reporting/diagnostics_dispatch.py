...
from ._diagnostics_adversarial import (  # noqa: F401  (re-exported; tests clear the cache through this module)
    _ADVERSARIAL_CACHE,
...
from ._diagnostics_pdp import (  # noqa: F401  (re-exported)
    _interaction_cost_within_budget,
...
from ._diagnostics_dispatch_extra import (  # noqa: F401
    _entry_score,
