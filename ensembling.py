        ...
        for ensemble_method in ensembling_methods:
            ...
            if uncertainty_quantile:
                ...
                res[internal_ensemble_method + " conf"] = train_and_evaluate_model(
                    ...
                    train_idx=train_idx[train_confident_indices] if train_idx is not None else None,
                    test_idx=test_idx[test_confident_indices] if test_idx is not None else None,
                    val_idx=val_idx[val_confident_indices] if val_idx is not None else None,
                    target_label_encoder=target_label_encoder,
                    compute_valset_metrics=True,
                    nbins=nbins,
                    custom_ice_metric=custom_ice_metric,
