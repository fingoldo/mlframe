        ...
        for ensemble_method in ensembling_methods:
            ...
            if uncertainty_quantile:
                res[internal_ensemble_method + " conf"] = train_and_evaluate_model(
                    ...
                    test_probs=test_ensembled_predictions[test_confident_indices] if test_ensembled_predictions is not None else None,
                    val_probs=val_ensembled_predictions[val_confident_indices] if val_ensembled_predictions is not None else None,
                    df=None,
                    default_drop_columns=[],
