...
@entry("binary", "calibration_reliability", "Reliability diagram with Wilson CI bands + binning-free smoothed (isotonic) overlay + standard & debiased ECE annotation + population histogram.")
def _b():
