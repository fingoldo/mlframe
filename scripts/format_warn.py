...
for _cmd in (
    ...
    # modernization) warnings the project deliberately keeps for 3.8/3.9 compatibility. Keep in sync with
    # pyproject's ignore list so the warn-only hook does not nag about deliberately-kept idioms.
