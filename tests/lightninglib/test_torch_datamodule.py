"""
Tests for TorchDataModule class in lightninglib.py

Run tests:
    pytest tests/lightninglib/test_torch_datamodule.py -v
    pytest tests/lightninglib/test_torch_datamodule.py --cov=mlframe.lightninglib --cov-report=html
"""
...
from mlframe.lightninglib import TorchDataModule
