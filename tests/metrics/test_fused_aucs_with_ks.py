...
def test_fast_aucs_per_group_optimized_return_ks():
    ...
    roc, _pr, _ga, _order, ks = fast_aucs_per_group_optimized(y_true=y_true, y_score=y_pred, group_ids=None, return_order=True, return_ks=True)
    ...
    roc2, _pr2, _ga2, ks2 = fast_aucs_per_group_optimized(y_true=y_true, y_score=y_pred, group_ids=None, return_ks=True)
