"""Wave 11a monolith-split sensor for ``mlframe.training._composite_target_estimator``.
...
def parent_module():
    from mlframe.training import _composite_target_estimator
    return _composite_target_estimator


@pytest.fixture(scope="module")
def siblings():
    from mlframe.training import (
        _composite_target_estimator_predict,
        _composite_target_estimator_update,
        _composite_target_estimator_utils,
    )
    return {
        "predict": _composite_target_estimator_predict,
        "update": _composite_target_estimator_update,
        "utils": _composite_target_estimator_utils,
    }
