"""
Integration tests for mlframe.training.neural - End-to-end workflows

Run tests:
    pytest tests/training/neural/test_integration.py -v
    pytest tests/training/neural/test_integration.py --cov=mlframe.training.neural --cov-report=html
"""
