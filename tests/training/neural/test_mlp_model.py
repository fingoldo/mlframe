"""
Tests for MLPTorchModel class in mlframe.training.neural

Run tests:
    pytest tests/training/neural/test_mlp_model.py -v
    pytest tests/training/neural/test_mlp_model.py --cov=mlframe.training.neural --cov-report=html
"""
