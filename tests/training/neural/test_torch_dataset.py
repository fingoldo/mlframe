"""
Tests for TorchDataset class in mlframe.training.neural

Run tests:
    pytest tests/training/neural/test_torch_dataset.py -v
    pytest tests/training/neural/test_torch_dataset.py --cov=mlframe.training.neural --cov-report=html
"""
...
from mlframe.training.neural import TorchDataset
