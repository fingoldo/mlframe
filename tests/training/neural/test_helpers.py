"""
Tests for helper functions in mlframe.training.neural

Run tests:
    pytest tests/training/neural/test_helpers.py -v
    pytest tests/training/neural/test_helpers.py --cov=mlframe.training.neural --cov-report=html
"""
