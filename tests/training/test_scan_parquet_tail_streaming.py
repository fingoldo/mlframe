...
def _make_cfg(tail=None, columns=None, n_rows=None, ensure_float32_dtypes=False,
              fillna_value=None, remove_constant_columns=False):
    cfg = types.SimpleNamespace(
        tail=tail, columns=columns, n_rows=n_rows,
