...
def test_caller_kwargs_extend_defaults_not_replace():
    ...
    assert mrmr_kwargs["max_runtime_mins"] == 300, (
        "max_runtime_mins default must survive caller override (A-P2-001 shallow-merge)"
    )
...
def test_default_verbose_tracks_suite_verbose():
    ...
    _, _, mrmr_kwargs = _initialize_training_defaults(
        common_params_dict=None, rfecv_models=None, mrmr_kwargs=None, suite_verbose=0,
    )
    ...
    _, _, mrmr_kwargs2 = _initialize_training_defaults(
        common_params_dict=None, rfecv_models=None, mrmr_kwargs=None, suite_verbose=2,
    )
...
def test_psutil_none_safe_fallback(monkeypatch):
    ...
    _, _, mrmr_kwargs = _initialize_training_defaults(
        common_params_dict=None, rfecv_models=None, mrmr_kwargs=None,
    )
    assert mrmr_kwargs["n_workers"] >= 1
