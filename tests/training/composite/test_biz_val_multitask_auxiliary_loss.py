...
def test_biz_val_multitask_auxiliary_loss_beats_single_task_near_boundary():
    ...
    assert improvement > 0.1, f"expected >10% MSE reduction near the boundary region, got {improvement:.4f} (single={mse_single_boundary:.4f}, multi={mse_multi_boundary:.4f})"
