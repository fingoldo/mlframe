...
# ``mlframe.training.neural`` (lightning + torchmetrics) / networkx /
# matplotlib stylesheet pulls in tens of submodules off disk and easily
# exceeds 180 s on the first test that hits them — that blew up the
# fuzz-suite run on 2026-04-27. Lazy-import getters in trainer.py defer
