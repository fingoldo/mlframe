...
def _build_combo(models: tuple[str, ...], axes: dict[str, Any], seed: int) -> FuzzCombo:
    return FuzzCombo(
        ...
        cross_sectional_neighbors_enabled_cfg=axes.get("cross_sectional_neighbors_enabled_cfg", False),
        ma_crossover_enabled_cfg=axes.get("ma_crossover_enabled_cfg", False),
        event_proximity_decay_enabled_cfg=axes.get("event_proximity_decay_enabled_cfg", False),
        two_step_target_encode_enabled_cfg=axes.get("two_step_target_encode_enabled_cfg", False),
        recency_aggregation_enabled_cfg=axes.get("recency_aggregation_enabled_cfg", False),
