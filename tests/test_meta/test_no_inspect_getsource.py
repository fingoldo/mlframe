...
WHITELIST: set[str] = {
    ...
    "test_meta/test_broad_except_logging_gpu_ktc_and_composite_models.py",
    "test_meta/test_broad_except_logging_composite_panel_and_core_predict.py",
    "test_meta/test_broad_except_logging_ar1_veto_and_pipeline_helpers.py",
    "test_meta/test_log_only_except_matplotlib_plotly_style_overrides.py",
    "test_meta/test_log_only_except_registry_and_phase_setup_best_effort.py",
    "test_meta/test_log_only_except_reports_and_phase_composite_best_effort.py",
    "test_meta/test_log_only_except_calibration_and_crash_reporting_best_effort.py",
