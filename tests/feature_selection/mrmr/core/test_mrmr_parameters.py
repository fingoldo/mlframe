...
class TestMRMRParameters:
    ...
    def test_quantization_nbins(self, simple_classification_data, nbins):
        ...
        mrmr = MRMR(quantization_nbins=nbins, full_npermutations=3, baseline_npermutations=3, verbose=0, n_jobs=1)
    ...
    def test_quantization_method(self, simple_classification_data, method):
        ...
        mrmr = MRMR(quantization_method=method, full_npermutations=3, baseline_npermutations=3, verbose=0, n_jobs=1)
    ...
    def test_mrmr_relevance_algo(self, simple_classification_data, algo):
        ...
        mrmr = MRMR(mrmr_relevance_algo=algo, full_npermutations=3, baseline_npermutations=3, verbose=0, n_jobs=1)
    ...
    def test_min_relevance_gain(self, simple_classification_data, min_gain):
        ...
        mrmr = MRMR(min_relevance_gain=min_gain, full_npermutations=3, baseline_npermutations=3, verbose=0, n_jobs=1)
    ...
    def test_verbose_levels(self, simple_classification_data):
        ...
        for verbose in [0, 1, 2]:
            mrmr = MRMR(full_npermutations=2, baseline_npermutations=2, verbose=verbose, n_jobs=1)
