...
def test_binom_cache_is_bounded_not_unbounded():
    """_binom_test_cached has a finite maxsize (not lru_cache(None)) generous enough to avoid mid-fit eviction."""
...
def test_binom_cache_still_memoizes():
    """Bounding the cache does not break memoization: an identical repeat call still registers as a cache hit."""
