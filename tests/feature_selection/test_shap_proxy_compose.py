...
def test_proposal_generator_emits_candidate_subsets():
    from mlframe.feature_selection._shap_proxy_compose import proposal_generator
...
def test_per_fold_stability_recovers_informative_with_high_frequency():
    from mlframe.feature_selection._shap_proxy_compose import per_fold_stability_select
