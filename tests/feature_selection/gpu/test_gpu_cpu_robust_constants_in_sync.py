...
The GPU heavy-tail / robust-scale batched ports (_gpu_resident_fe._GPU_ROBUST_AXIS_*) redeclare the
...
def test_gpu_robust_axis_constants_match_cpu():
    """The GPU-side heavy-tail/robust-scale constants (redeclared to avoid an import cycle) must equal the CPU reference exactly, or GPU routing silently drifts."""
