...
from mlframe.feature_selection.shap_proxied_fs._shap_proxy_objective import subset_uncertainty
...
def test_compute_shap_matrix_n_estimators_cap_is_clamp():
    ...
    from mlframe.feature_selection.shap_proxied_fs import _shap_proxy_explain
    from mlframe.feature_selection.shap_proxied_fs._shap_proxy_explain import compute_shap_matrix, make_default_estimator
...
def test_facade_oof_shap_n_estimators_passes_to_compute_shap_matrix():
    ...
    from mlframe.feature_selection.shap_proxied_fs import _shap_proxy_explain as explain_module
    from mlframe.feature_selection.shap_proxied_fs import ShapProxiedFS
