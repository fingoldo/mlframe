...
``mlframe.feature_selection._shap_proxy_revalidate``.
...
def test_phi_t_kwarg_skips_internal_transpose(monkeypatch):
    ...
    import mlframe.feature_selection._shap_proxy_calibrate as calib_mod
...
def test_proxy_trust_guard_passes_precomputed_phi_t(monkeypatch):
    ...
    import mlframe.feature_selection._shap_proxy_revalidate as reval_mod
