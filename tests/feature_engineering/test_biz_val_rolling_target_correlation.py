...
def test_biz_val_rolling_target_correlation_tracker_beats_static_selection_mse():
    ...
    assert improvement > 0.7, f"expected >70% MSE reduction vs. a static one-time feature selection, got {improvement:.4f} (static={mse_static:.4f}, dynamic={mse_dynamic:.4f})"
