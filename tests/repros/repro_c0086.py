...
try:
    trained, _ = train_mlframe_models_suite(
        ...
        preprocessing_config=PreprocessingConfig(drop_columns=[], category_encoder=ce.CatBoostEncoder(), scaler=StandardScaler(), imputer=SimpleImputer(strategy='mean')),
        verbose=0,
        use_ordinary_models=True, use_mlframe_ensembles=False,
        output_config=OutputConfig(data_dir=r'D:/Temp/repro_c0086_v2', models_dir='models'),
